  ...
  create  table
    "n26"."credit_risk_playground"."bp_overdraft_limit_periods_ik__dbt_tmp"
...
inner join etl_reporting.cmd_users z using(user_created)
--left join min_pu_user_date mp on mp.user_id = z.user_id
...
inner join "n26"."dbt"."mmbr_user_match" cl on cl.user_id = f.user_id
inner join "n26"."public"."mmbr_savings_account" s on s.account_holder_key = cl.mmbr_client_key 
