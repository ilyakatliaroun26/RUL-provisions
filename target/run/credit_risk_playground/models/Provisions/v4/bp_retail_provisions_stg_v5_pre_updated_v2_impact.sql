  ...
  create  table
    "n26"."credit_risk_playground"."bp_retail_provisions_stg_v5_pre_updated_v2_impact"
...
left join "n26"."credit_risk_playground"."bp_application_pd_supermodel_m_v2_impact" pd_app on pd_app.encoded_key = c.encoded_key 
...
left join "n26"."credit_risk_playground"."bp_monitoring_pd_supermodel_v2_m_v2_impact" m on m.user_id = c.user_id and m.reporting_date::date = c.reporting_date::date
