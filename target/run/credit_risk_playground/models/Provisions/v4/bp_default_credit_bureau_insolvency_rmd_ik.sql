  ...
  create  table
    "n26"."credit_risk_playground"."bp_default_credit_bureau_insolvency_rmd_ik__dbt_tmp"
...
raw_merkmal_description as (SELECT  ca.user_id,
     ...
     inner join credit_risk_playground.bp_default_credit_bureau_insolvency_max_date_ik m
