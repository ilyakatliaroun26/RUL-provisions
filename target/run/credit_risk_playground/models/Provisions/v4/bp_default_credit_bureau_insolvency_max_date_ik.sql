  ...
  create  table
    "n26"."credit_risk_playground"."bp_default_credit_bureau_insolvency_max_date_ik__dbt_tmp"
...
inner join credit_risk_playground.bp_portfolio_customers_aud_m_ik as portfolio ON portfolio.user_id = csr.user_id
