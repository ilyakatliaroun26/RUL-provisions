  ...
  create  table
    "n26"."credit_risk_playground"."bp_retail_provisions_stg_v5_v4_updated_v2_impact"
...
from "n26"."credit_risk_playground"."bp_retail_provisions_stg_v5_pre_updated_v2_impact" c 
...
left join "n26"."credit_risk_playground"."bp_monitoring_pd_supermodel_v2_m_v2_impact" m on m.user_id = c.user_id and m.reporting_date::date = c.reportdate::date
left join "n26"."credit_risk_playground"."bp_application_pd_supermodel_m_v2_impact" pd_app on pd_app.encoded_key = c.instrument_id 
                                                                and  pd_app.reporting_date::date = c.reportdate::date
                                                                and c.product_flag not in ('Unarranged Overdraft', 'RP_2')
left join "n26"."credit_risk_playground"."bp_application_pd_supermodel_m_ad_v2_impact" pd_app_ad on pd_app_ad.encoded_key = c.instrument_id 
