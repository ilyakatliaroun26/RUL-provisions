...
from "n26"."credit_risk_playground"."bp_overdraft_limit_periods_ik" s 
where s.amount_cents > 0 and s.rev_timestamp::date <= '2025-06-11'::date
group by s.user_id 
)
...
select * 
from "n26"."credit_risk_playground"."bp_portfolio_balance_aud_m_ik" b
where b.reporting_date = '2025-06-11'::date
...
where etl_updated > (select max(etl_updated) from "n26"."credit_risk_playground"."bp_overdraft_split_m_ik")
