...
, pd_app as (
    ...
    where ps.model_name = 'PORTO'
          ...
          and ps.score_type in ('behavioral')
           and c.reporting_date::date = '2025-06-11'::date
...
where etl_updated > (select max(etl_updated) from "n26"."credit_risk_playground"."bp_application_pd_supermodel_m_ad_ik")
