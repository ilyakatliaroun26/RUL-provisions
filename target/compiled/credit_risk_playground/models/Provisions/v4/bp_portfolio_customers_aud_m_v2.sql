...
-- dbt run --models bp_portfolio_customers_aud_m_v2 (other runs)
    ...
    , encoded_key
    , reporting_date
    from "n26"."credit_risk_playground"."bp_portfolio_balance_aud_m_v2"
    ...
    from "n26"."credit_risk_playground"."bp_overdraft_limit_periods_v2"  f
    ...
    where etl_updated > (select max(etl_updated) from "n26"."credit_risk_playground"."bp_portfolio_customers_aud_m_v2")
