...
bp_overdue_amt_aud_m_v2 (first drop)
bp_arrears_reg_aud_v2 (first drop)
bp_overdraft_split_m_v2 
bp_monitoring_pd_supermodel_m_v2
bp_macroeconomic_scenarios_supermodel_updated_v2
bp_supermodel_pd_pit_m_updated_v2
bp_credit_bureau_rating_m_v2
bp_default_dunning_m_v2
bp_default_internal_insolvency_m_v2
...
where etl_updated > (select max(etl_updated) from "n26"."credit_risk_playground"."bp_retail_provisions_m_v2")
