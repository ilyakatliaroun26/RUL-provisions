...
FROM credit_risk_playground.bp_default_credit_bureau_insolvency_me_ik AS merkmal_exploded
)
...
select distinct
              ccra.user_id 
              , '2025-06-11'::date  as rev_timestamp
...
where etl_updated > (select max(etl_updated) from "n26"."credit_risk_playground"."bp_default_credit_bureau_insolvency_v3_m_ik")
